...
export default function HomePage() {
  ...
  const TEST_PUBLIC_ADDRESS = "0xBA5deA80566bCB1d79ec380fF4aCde3815a09c8b"
  const TOKEN_URI = "https://storage-chainbot.chaincuet.com/imagebot/c0d411f7-7109-4afe-ac17-4d4d91ee7450"
  ...
  const onClickButton = async (publicAddress: string, tokenURI: string) => {
    /*TODO use metmask with sepolia web3*/
    if(NEXT_PUBLIC_INFURA_API_KEY){
      const web3 = new Web3(new Web3.providers.HttpProvider(NEXT_PUBLIC_INFURA_API_KEY));
      ...
      const transactionParameters = {
        ...
        data: contract.methods.mintNFT(publicAddress, tokenURI).encodeABI(),
      };
  ...
  return (
    <div>
      <button onClick={() => onClickButton(TEST_PUBLIC_ADDRESS, TOKEN_URI)} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
        Mint NFT
      </button>
    </div>
  );
