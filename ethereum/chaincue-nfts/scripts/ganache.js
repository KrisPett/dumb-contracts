...
const chaincueNFT = await ChaincueNFT.deployed()
console.log(chaincueNFT)
...
let nftToken2 = await contract.methods.tokenURI(2).call();
console.log(nftToken1)
console.log(nftToken2)
